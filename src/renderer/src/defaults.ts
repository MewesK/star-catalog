...
export const DISTANCE_MULTIPLIER = 1.0; // Unscientific :)
export const SIZE_MULTIPLIER = 1.0; // Unscientific :)
...
export const RENDER_DISTANCE_3D = 10.0; // 1/SCALE_MULTIPLIER pc
...
export const CAMERA_SPEED_DEFAULT = 0.02 * ZOOM_MULTIPLIER;
